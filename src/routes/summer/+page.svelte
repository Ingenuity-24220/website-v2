<script>
    ...
    import about from '$lib/assets/images/summer.png';
...
<style>
    ...
    .about-img-1 {
        ...
        height: auto;
        display: block;
        -webkit-mask-image: linear-gradient(to top, black 0%, transparent 95%);
        mask-image: linear-gradient(to top, black 0%, transparent 95%);
